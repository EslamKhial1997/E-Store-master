...
const ShoppingCart = () => {
  return (
    <div>
      <section className="h-100 gradient-custom bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-gray-50">
        <div className="container py-1 ">
          <div className="row d-flex justify-content-center bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-gray-50 ">
