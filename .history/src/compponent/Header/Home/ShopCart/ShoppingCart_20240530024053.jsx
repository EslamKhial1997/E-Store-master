        ...
        <div className="container py-1">
          <div className="row d-flex justify-content-center ">
            <div className={` col-md-4 h-100`}>
              <div className=" bg-gray-900 text-light my-3 p-2 rounded-lg ">
              ...
              <div className="d-flex flex-wrap">
                <div className="bg-gray-900 p-3 rounded-lg text-light mb-4 col-12">
            ...
            <div className="col-md-8 py-3  text-light">
              <div className=" bg-gray-900 mb-4 rounded-lg p-2">
                ...
                <div className="card-body bg-gray-700 p-2 h-screen overflow-y-auto overflow-x-hidden SideBarProduct">
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-5 col-md-6 mb-4 mb-lg-0">
                      ...
                      <button
                        type="button"
                        className="btn bg-danger btn-sm me-1 mb-2"
