          ...
          <div className="row d-flex justify-content-center ">
            <div className={` col-md-4 h-100`}>
              ...
              <div className="d-flex flex-wrap">
                <div className="bg-gray-200 p-3 rounded-lg text-dark mb-4 col-12">
            ...
            <div className="col-md-8 py-3  text-light">
              <div className=" bg-gray-900 mb-4 rounded-lg p-2">
                ...
                <div className="card-body bg-gray-200 p-2 h-screen overflow-y-auto overflow-x-hidden SideBarProduct">
