...
<div className="d-flex justify-between px-2 bg-dark-850">
<h3 className="my-3 md:col-3 col-3 text-dark">Results:20 </h3>

<div className='sm:col-8 bg-danger md:col-3 '>
