...
const Products = () => {
  ...
  const products = data.map((ele) =>
    isLoading ? (
      ...
      <div className=" col-11 text-center col-lg-3" key={ele._id}>
      <div
        className="col-12  m-3  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
  ...
  return <div className="d-flex flex-wrap content-between gap-4">{products}</div>;
};
