...
const Products = () => {
  ...
  return (
    <div className="d-flex flex-wrap content-between bg-danger">
      {isLoading ? (
        <div className="col-12 d-flex justify-content-center  flex-wrap m-auto  p-3 absolute top-50">
        ...
        <div className="col-12 justify-center  p-3 absolute top-50">
