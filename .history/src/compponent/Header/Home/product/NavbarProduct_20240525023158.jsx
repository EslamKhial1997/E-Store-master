  ...
  return (
    <nav>
      <div className="max-w-screen flex flex-wrap items-center justify-center mx-auto bg-gradient-to-r from-slate-900 ...">
        ...
        >
          <ul className="flex  p-2 md:p-0  font-medium  rounded-lg   md:mt-0 md:border-0 ">
            <li className="border rounded-lg ">
              <a
                href="#"
                className=" py-2 px-3 text-white  rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500"
                aria-current="page"
              >
                Category
              </a>
