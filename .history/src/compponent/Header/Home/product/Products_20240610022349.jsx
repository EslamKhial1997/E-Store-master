...
const Products = () => {
  ...
  return (
    <div className="d-flex flex-wrap content-between relative">
      {isLoading ? (
        <div className="col-12 d-flex justify-content-center  flex-wrap m-auto  p-3  bg-danger absolute top-0">
        ...
        // </div>
        <div className="col-12 d-flex justify-content-center  flex-wrap m-auto  p-3  bg-danger absolute bottom-0 ">
          <span className="loader"></span>
          <h1 className="col-12 text-center">Loading..........</h1>
        </div>
      )}
