...
<aside id="sidebar-multi-level-sidebar" className={`${Style.SideBar} w-64 transition-transform -translate-x-full sm:translate-x-0 d-flex d-lg-block d-md-flex d-sm-flex`}
