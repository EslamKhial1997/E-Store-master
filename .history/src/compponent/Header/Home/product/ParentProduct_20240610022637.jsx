  ...
  return (
    <div className=" py-3">
      ...
      <div className="d-flex justify-content-around flex-wrap ">
        ...
        <div className="col-lg-9 col-12 h-screen overflow-scroll justify-content-center align-items-center bg-info SideBarProduct">
          <div className="lg:flex hidden m-auto content-between">
