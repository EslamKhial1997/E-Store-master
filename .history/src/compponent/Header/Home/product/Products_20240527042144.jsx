...
const Products = () => {
  ...
  const products = data.map((ele) =>
      ...
      <div
        className="col-12   bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
  ...
  return <div className="d-flex flex-wrap content-between">
{
  isLoading ? (
    <div className="col-12 p-3 col-lg-3" ><div className="text-center d-flex justify-center">
    <h1 className="text-center tex">Loading.....................</h1>
    </div></div>
  ) : (
  products
  )
