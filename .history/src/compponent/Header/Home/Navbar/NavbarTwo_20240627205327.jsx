...
const NavbarTwo = () => {
  ...
  return (
    <div className="navbar bg-base-100 bg-danger ">
      <div className="">
      ...
      <div className=" hidden md:flex lg:flex  bg-info relative">
        <ul className="menu menu-horizontal px-1 absolute left-50">
          <li>
            <a>Item 1</a>
          </li>
          <li>
