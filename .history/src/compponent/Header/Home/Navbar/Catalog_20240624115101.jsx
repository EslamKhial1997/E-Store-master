  ...
  return (
    <li>
      <button
        ...
        className="flex items-center justify-between w-full py-2 px-3 font-medium dark:text-gray-50 text-ga border-b border-gray-100 md:w-auto hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700"
      >
        Company
        <svg
