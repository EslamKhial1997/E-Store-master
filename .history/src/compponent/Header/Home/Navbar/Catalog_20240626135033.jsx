const Catalog = () => {
  return (
    <li onClick={()=>{console.log("")}} className="hover:bg-gray-200 rounded-xl dark:hover:bg-gray-500 dark:text-gray-50 text-gray-950  hover:text-blue-500 dark:hover:text-blue-300">
      <button
