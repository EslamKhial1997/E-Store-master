  ...
  return (
    <li className="hover:bg-gray-200 rounded-xl dark:hover:bg-gray-500 dark:text-gray-50 text-gray-950  hover:text-blue-500 dark:hover:text-blue-300">
      <button
        ...
        className="flex items-center justify-between w-full py-2 px-3 font-medium  md:w-auto hover:bg-gray-50  md:border-0  md:p-0  dark:hover:bg-gray-700  md:dark:hover:bg-transparent dark:border-gray-700"
      >
        Company
        <svg
