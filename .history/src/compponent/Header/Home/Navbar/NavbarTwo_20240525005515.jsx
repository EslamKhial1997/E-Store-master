    ...
    <nav className="bg-gray-900 border-gray-200 dark:bg-gray-900 p-3">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto ">
        <a
          ...
          className="flex items-center space-x-3 rtl:space-x-reverse hidden lg:flex"
        >
          <img
        ...
        <div class="flex items-center content-between md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        ...
        >
          ...
          <ul className="flex flex-col md:p-0  font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <a
                href="#"
            ...
            <li>
              ...
              >
                <ul
                  className="py-2 text-sm bg-gray-700 text-gray-700 dark:text-gray-200"
                ...
                <div className="">
                  <a
                    href="#"
                    className="block px-4 py-2 text-sm bg-red-500 text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white"
                  >
                    Sign out
                  </a>
                </div>
