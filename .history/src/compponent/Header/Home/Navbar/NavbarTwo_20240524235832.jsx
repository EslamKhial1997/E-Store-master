    ...
    <nav className="bg-gray-900 border-gray-200 dark:bg-gray-900 p-3">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto ">
        ...
        >
          ...
          <ul className="flex flex-col md:p-0  font-medium border border-gray-100 rounded-lg bg-dark-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <a
                href="#"
