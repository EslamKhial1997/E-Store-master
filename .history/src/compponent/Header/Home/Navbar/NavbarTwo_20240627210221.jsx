...
const NavbarTwo = () => {
  ...
  return (
    <div className="navbar bg-gray-100 dark:bg-gray-800 dark:text-gray-50 font-medium">
      <div className="">
      ...
      <div className=" hidden md:flex lg:flex bg-gray-200 dark:bg-gray-900 rounded-xl">
        <ul className="menu menu-horizontal px-1">
          <li className="dark:hover:bg-gray-100 rounded dark:hover:text-gray-950 hover:bg-gray-800 hover:text-gray">
            <a>Home</a>
          </li>
          <li className="dark:hover:bg-gray-100 rounded dark:hover:text-gray-950 hover:bg-gray-800 hover:text-gray">
            <a>Item 1</a>
