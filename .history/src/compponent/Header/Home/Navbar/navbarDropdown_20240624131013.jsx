        ...
        <ul className="py-2" aria-labelledby="user-menu-button">
          <li className="dark:text-gray-200">
            <button
              ...
              className="inline-flex items-center font-medium justify-center w-100 px-4 py-2 text-sm text-gray-900 dark:text-white rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white"
            >
              <svg
