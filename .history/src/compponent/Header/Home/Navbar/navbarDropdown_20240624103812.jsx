    ...
    <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      ...
      >
        ...
        <ul className="py-2" aria-labelledby="user-menu-button">
          ...
          <li>
          <label className="inline-flex items-center content-center cursor-pointer px-4 py-2">
          ...
          <span className="ms-3 text-sm font-medium text-gray-50 dark:text-gray-300">Red</span>
        </label>
