    ...
    <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      ...
      >
        ...
        <ul className="py-2" aria-labelledby="user-menu-button">
          <li className="dark:text-gray-200 border-b-2">
            <a
              href="#"
          ...
          <li className="dark:text-gray-200 border-solid">
            <a
              href="#"
              className="block px-4 py-2 text-sm  hover:bg-gray-700 dark:hover:bg-gray-600  hover:text-gray-50"
            >
          ...
          <li className="px-4 py-2">
            ...
            >
              ...
              <span onClick={themes}>Dark</span>
              <span onClick={()=>{ localStorage.removeItem('theme')}}>Light</span>
            </label>
          </li>
        </ul>
      </div>
