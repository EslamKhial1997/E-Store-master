...
const NavbarTwo = () => {
  ...
  return (
    <div className="navbar bg-base-100 bg-danger relative">
      <div className="">
      ...
      <div className=" hidden md:flex lg:flex  relative">
        <ul className="menu menu-horizontal px-1 ">
          ...
          <li>
            <details>
              ...
              <ul className="menu xl:menu-horizontal bg-base-200 rounded-box lg:min-w-max absolute left-0">
              <li>
                <a>Solutions</a>
                <ul>
                  <li><a>Design</a></li>
