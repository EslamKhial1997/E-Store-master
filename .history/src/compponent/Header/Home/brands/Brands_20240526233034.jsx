...
export default function Brands() {
  ...
  return (
    ...
    <div className="bg-warning d-flex col-12 justify-content-around align-items-center fw-bold  my-5 p-4  rounded">
    <strong className="col-8  fs-5" style={{ color: "#072541" }}>
      Big offers on new collection
    </strong>
    <span
      className="col-3 text-center rounded -h text-light"
