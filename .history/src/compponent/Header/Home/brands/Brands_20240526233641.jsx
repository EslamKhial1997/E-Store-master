...
export default function Brands() {
  ...
  return (
    <div className="mt-5">
    <div className="bg-gray-900 border-bottom d-flex col-12 justify-content-around align-items-center fw-bold  p-2 ">
    <span
    className="col-2 text-center rounded py-2 bg-body text-gray-950"
