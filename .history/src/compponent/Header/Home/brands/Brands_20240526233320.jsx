...
export default function Brands() {
  ...
  return (
    <div className="my-5">
    <div className="bg-gray-800 d-flex col-12 justify-content-around align-items-center fw-bold  my-5 p-4  rounded">
    <strong className="col-8  text-light tracking-widest">
      Big offers on new collection
    </strong>
    <span
      className="col-3 text-center rounded p-2 bg-body text-gray-600"
