...
const ProfileLeft = () => {
  return (
    <div className="col-12 text-start p-2 ">
      ...
      <div
        className={`${Style.SideBar} SideBar d-flex d-lg-block d-md-flex d-sm-flex`}
        style={{ overflow: "scroll" }}
      >
        <NavLink
          to={"qrcode"}
          end
          className={`col-lg-12 col-3 justify-content-lg-between justify-content-center d-flex mx-1 m-2 mx-lg-0 rounded bg-gray-950
