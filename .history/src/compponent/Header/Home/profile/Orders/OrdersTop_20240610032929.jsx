  ...
  return (
    <div className="container  flex-wrap border-warning py-2 rounded-xl text-light">
      ...
      <div className="d-flex col-12 justify-content-between flex-wrap">
        <List
          className="col-lg-4 col-12 border mt-2 rounded-xl"
          component="nav"
        ...
        >
          ...
          >
            ...
            <div className="bg-dark rounded-full"> {open ? <ExpandLess  color="warning" /> : <ExpandMore color="error"/>}</div>
          </ListItemButton>
          <Collapse in={open} timeout="auto" unmountOnExit>
            <List component="div" disablePadding>
              <div className="d-flex flex-wrap  col-12  text-dark fw-bold  p-2 ">
        ...
        >
          ...
          <Collapse in={open} timeout="auto" unmountOnExit>
            <List component="div" disablePadding>
            <div className="d-flex flex-wrap  col-12  text-dark  p-2 ">
                <div className="col-12">
                  <span className="d-block">
        ...
        <List
          className="col-lg-3 col-12 border mt-2 rounded-xl"
          component="nav"
          aria-labelledby="nested-list-subheader"
        >
          <ListItemButton
