...
const OrdersTop = () => {
  ...
  return (
    <div className="container  flex-wrap border-warning py-2 rounded-xl text-light">
      <div className="d-flex col-12 justify-content-between align-items-center p-2 bg-gradient-to-r from-indigo-500">
      ...
      <div className="d-flex col-12 justify-content-between flex-wrap">
        ...
        >
          <ListItemButton
            onClick={handleClick}
            className=" bg-gradient-to-r from-indigo-500 text-light d-flex justify-content-around align-items-center"
          ...
          <Collapse in={open} timeout="auto" unmountOnExit>
            <List component="div" disablePadding>
              <div className="d-flex flex-wrap  col-12 bg-gray-900  p-2 ">
