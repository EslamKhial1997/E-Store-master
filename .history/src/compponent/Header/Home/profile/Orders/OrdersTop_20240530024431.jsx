...
const OrdersTop = () => {
  ...
  return (
    <div className="container  flex-wrap border-warning py-2 rounded-lg text-light">
      <div className="d-flex col-12 justify-content-between align-items-center bg-gray-900">
        <h2 className="py-3 t  fw-bold text-capitalize">
          Order Details
        </h2>
