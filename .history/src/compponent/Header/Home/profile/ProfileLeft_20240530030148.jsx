    ...
    <div className="col-12 text-start p-2 ">
      ...
      >
        <NavLink
          ...
          className={`col-lg-12 col-3 justify-content-lg-between justify-content-center d-flex mx-1 m-2 mx-lg-0 rounded bg-gradient-to-r from-indigo-500
              shadow-lg hover:bg-gradient-to-r from-indigo-500 active:bg-gray-100 focus:outline-none focus:ring focus:ring-violet-300`}
        >
