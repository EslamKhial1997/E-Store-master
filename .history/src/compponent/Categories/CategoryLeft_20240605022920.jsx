    ...
    >
      ...
      >
       ...
       border border-bottom  shadow-lg ${Style.Popular}`}
        >
          <div
            className="hover:bg-gradient-to-r from-salt-500 hover:bg-gradient-to-r from-salt-500 justify-content-lg-between align-items-center justify-content-center d-flex flex-wrap p-2 text-center rounded "
