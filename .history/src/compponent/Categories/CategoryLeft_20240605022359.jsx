...
const CategoryLeft = () => {
  return (
    ...
    >
      ...
      >
        <div
          className={`bg-gradient-to-r from-slate-500 col-lg-12 col-3 justify-content-lg-between justify-content-center d-flex mx-1 m-2 mx-lg-0 rounded bg-white
       ...
       border border-bottom  shadow-lg ${Style.Popular}`}
        ...
        <div
          className={` bg-gradient-to-r from-slate-500col-lg-12 col-3 justify-content-lg-between justify-content-center d-flex mx-1 m-2 mx-lg-0 rounded bg-white
       border border-bottom  shadow-lg ${Style.Popular}`}
        >
          <div
            className=" justify-content-lg-between align-items-center justify-content-center d-flex flex-wrap p-2 text-center rounded "
       ...
       border border-bottom  shadow-lg ${Style.Popular}`}
        ...
        <div
          className={` bg-gradient-to-r from-slate-500col-lg-12 col-3 justify-content-between d-flex mx-1 m-2 mx-lg-0 rounded bg-white
       border border-bottom  shadow-lg ${Style.Popular}`}
        >
          <div
            className=" justify-content-lg-between align-items-center justify-content-center d-flex flex-wrap p-2 text-center rounded "
       ...
       border border-bottom  shadow-lg ${Style.Popular}`}
        ...
        <div
          className={`bg-gradient-to-r from-slate-500 col-lg-12 col-3 justify-content-between d-flex mx-1 m-2 mx-lg-0 rounded bg-white
       border border-bottom  shadow-lg ${Style.Popular}`}
        >
          <div
            className=" justify-content-lg-between align-items-center justify-content-center d-flex flex-wrap p-2 text-center rounded "
