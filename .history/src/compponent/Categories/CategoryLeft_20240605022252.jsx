...
const CategoryLeft = () => {
  return (
    <div
      className="col-12  p-2 border rounded bg-gradient-to-r from-slate-500"
    ...
    >
      ...
      >
        <div
          className={`hover:bg-danger col-lg-12 col-3 justify-content-lg-between justify-content-center d-flex mx-1 m-2 mx-lg-0 rounded bg-white
       border border-bottom  shadow-lg ${Style.Popular}`}
        >
          <div
            className="bg-transparent justify-content-lg-between align-items-center justify-content-center d-flex flex-wrap p-2 text-center rounded "
