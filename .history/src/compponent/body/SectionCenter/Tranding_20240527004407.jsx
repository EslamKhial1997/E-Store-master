  ...
  return (
    <div>
      <div className="flex items-center justify-center py-4 md:py-8 flex-wrap">
        ...
        <button
          type="button"
          className="text-gray-900 border border-white hover:border-gray-200 dark:border-gray-900 dark:bg-gray-900 dark:hover:border-gray-700 bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 rounded-full text-base font-medium px-5 py-2.5 text-center me-3 mb-3 dark:text-white dark:focus:ring-gray-800"
        >
          Shoes
        </button>
        <button
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        <div className="cursor-pointer drop-shadow-xl transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 ">
          <img
        ...
        <div className="cursor-pointer drop-shadow-xl">
          <img
            className="h-auto max-w-full rounded-lg"
