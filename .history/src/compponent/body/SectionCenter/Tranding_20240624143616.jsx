    ...
    <div>
      <div className="d-flex items-center justify-center my-3">
        <div className=" col-12 py-4 md:py-8 d-flex overflow-x-scroll SideBarProduct">
          <button
            type="button"
            className=" text-blue-700 hover:text-black border border-blue-600 bg-white hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-xl    text-center  m-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-gray-950 dark:hover:bg-blue-500 dark:bg-gray-900 dark:focus:ring-blue-800"
          >
            All categories
          </button>
          <button
