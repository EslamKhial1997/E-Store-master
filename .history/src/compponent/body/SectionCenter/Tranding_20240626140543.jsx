    ...
    <div className="py-3">
      <div className="d-flex items-center justify-center my-3">
        <div className=" col-12 py-4 md:py-8 d-flex overflow-x-scroll SideBarProduct">
          <button
            type="button"
            className="text-nowrap fw-bold text-blue-700 hover:text-black border border-blue-600 bg-white hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-xl    text-center p-2 m-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-nowrap text-gray-950 dark:hover:bg-blue-500 dark:bg-gray-900 dark:focus:ring-blue-800"
          >
            All categories
          </button>
          <button
            type="button"
            className="text-nowrap text-gray-700 border bg-gray-200 border-white hover:border-blue-700 hover:text-blue-500 dark:hover:text-blue-500 dark:border-gray-900 dark:bg-gray-900 dark:hover:border-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 rounded-full text-base font-medium p-2 m-2 text-center dark:text-white dark:focus:ring-gray-800"
          >
            Shoes
          </button>
          <button
