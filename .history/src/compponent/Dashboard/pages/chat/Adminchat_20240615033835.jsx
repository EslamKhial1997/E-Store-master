...
const Adminchat = () => {
  return (
    <div className="d-flex col-10 h-screen">
      <section className="discussions col-3 ">
        <div className="discussion search mt-20">
      ...
      <section className="chat col-9 h-screen overflow-scroll pt-20 SideBarProduct">
