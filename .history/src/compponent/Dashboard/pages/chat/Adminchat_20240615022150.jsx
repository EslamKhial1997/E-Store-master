  ...
  return (
    ...
    <div className="row">
      ...
      <section className="discussions">
        ...
        <div className="discussion">
          <div className="photo" style="background-image: url(https://images.unsplash.com/photo-1497551060073-4c5ab6435f12?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=667&q=80);">
          </div>
          <div className="desc-contact">
        ...
        <div className="discussion">
          <div className="photo" style="background-image: url(https://card.thomasdaubenton.com/img/photo.jpg);">
            <div className="online"></div>
          </div>
          <div className="desc-contact">
        ...
        <div className="discussion">
          <div className="photo" style="background-image: url(https://images.unsplash.com/photo-1553514029-1318c9127859?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=700&q=80);">
          </div>
          <div className="desc-contact">
        ...
        <div className="discussion">
          <div className="photo" style="background-image: url(https://images.unsplash.com/photo-1541747157478-3222166cf342?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=967&q=80);">
          </div>
          <div className="desc-contact">
        ...
        <div className="discussion">
          <div className="photo" style="background-image: url(https://images.unsplash.com/photo-1435348773030-a1d74f568bc2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1050&q=80);">
            <div className="online"></div>
          </div>
          <div className="desc-contact">
