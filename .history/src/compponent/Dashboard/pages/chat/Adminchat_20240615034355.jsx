...
const Adminchat = () => {
  return (
    <div className="d-flex col-10  bg-danger ">
      ...
      <section className="chat col-9 h-screen overflow-scroll mt-16 SideBarProduct">
        <div className="header-chat col-11">
         <div className="d-flex"> <i className="icon fa fa-user-o" aria-hidden="true"></i>
         <p className="name">Megan Leib</p></div>
          <i
